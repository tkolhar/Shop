...
public class AppTest {
    ...
    public void removeOrder() throws IOException, InterruptedException {
        ...
        driver.findElement(By.cssSelector("#header_cart > a")).click();
        Thread.sleep(1000);
        String value = driver.findElement(By.cssSelector("#checkout_page_container > div.slide1 > table > tbody > tr.product_row.product_row_0.alt > td.wpsc_product_quantity.wpsc_product_quantity_0 > form > input[type=\"text\"]:nth-child(1)")).getAttribute("value");
        assertEquals(value,"1");
        log.info("Initial quantity is 1.");
        driver.findElement(By.name("quantity")).clear();
